...
def input_user():
    ...
    st.sidebar.write('Belum Bekerja = 0, Bekerja = 1')
    st.sidebar.write("")

    Umur = st.sidebar.number_input('**Umur**', min_value=0.00)
    st.sidebar.write('Usia saat melakukan pendaftaran')   
    st.sidebar.write("")

    StatusNikah = st.sidebar.selectbox('**StatusNikah**', ('0', '1'))
    st.sidebar.write(":orange[Belum Menikah] = :orange[0], :green[Menikah] = :green[1]")            
    st.sidebar.write("")
